...
/// ```
class FrameBackgroundExample extends StatefulWidget {
  /// Creates a new [FrameBackgroundExample] widget.
  const FrameBackgroundExample({super.key});

  @override
  State<FrameBackgroundExample> createState() => _FrameBackgroundExampleState();
}

/// The state for the [FrameBackgroundExample] widget.
class _FrameBackgroundExampleState extends State<FrameBackgroundExample>
    with ExampleHelperState<FrameBackgroundExample> {
            ...
            configs: ProImageEditorConfigs(
              ...
              paintEditor: PaintEditorConfigs(
                widgets: PaintEditorWidgets(
                  ...
                  bottomBar: (paintEditor, rebuildStream) => ReactiveWidget(
                    stream: rebuildStream,
                    builder: (_) =>
                        _bottomBarPaintEditor(paintEditor, constraints),
                  ),
                ),
              ),
              ...
              layerInteraction: LayerInteractionConfigs(
                ...
                widgets: LayerInteractionWidgets(
                  editButton: (rebuildStream, onTap, rotation) =>
                      ReactiveWidget(
                    stream: rebuildStream,
                    builder: (_) {
                      return Positioned(
                  ...
                  removeButton: (rebuildStream, onTap, rotation) =>
                      ReactiveWidget(
                    builder: (_) {
                      return Positioned(
                        top: 0,
  ...
  // Method to select an image for the circular canvas
  void _selectCircularImage() async {
    final ImagePicker picker = ImagePicker();
